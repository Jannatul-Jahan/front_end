...
import ForgetPasswordPage from "./pages/register/forgetpassword.page";
import ResetPasswordPage from "./pages/register/resetpassword.page"
  ...
  return (
    <>
      <Routes>
        ...
        <Route path="/users/reset-password/:token/:id" element={<ResetPasswordPage />} />
